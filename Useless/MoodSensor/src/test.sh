...
declare -a expected
expected[0]="--- Mood Sensor v1.0 ---"$'\n'"Your true emotions are coming across my screen."$'\n'"At this moment, you are..."$'\n'$'\n'"      HAPPY!"$'\n'"     -------"$'\n'"    |       |"$'\n'"    | O   O |"$'\n'"    |   <   |"$'\n'"    | .   . |"$'\n'"    |  ...  |"$'\n'"     -------"
expected[1]="--- Mood Sensor v1.0 ---"$'\n'"Your true emotions are coming across my screen."$'\n'"At this moment, you are..."$'\n'$'\n'"     Neutral"$'\n'"     -------"$'\n'"    |       |"$'\n'"    | O   O |"$'\n'"    |   <   |"$'\n'"    |  ___  |"$'\n'"    |       |"$'\n'"     -------"
expected[2]="--- Mood Sensor v1.0 ---"$'\n'"Your true emotions are coming across my screen."$'\n'"At this moment, you are..."$'\n'$'\n'"       Sad"$'\n'"     -------"$'\n'"    |       |"$'\n'"    | O   O |"$'\n'"    |   <   |"$'\n'"    |  ...  |"$'\n'"    | '   ' |"$'\n'"     -------"
expected[3]="--- Mood Sensor v1.0 ---"$'\n'"Your true emotions are coming across my screen."$'\n'"At this moment, you are..."$'\n'$'\n'"...yikes, in a really bad mood!!! Cheer up!"
run_test_multiple_outputs "0" 30
